...
export default function PrestamosCreate() {
  ...
  useEffect(() => {
    axios
      .get("https://api-prestamos.onrender.com/users",{
        headers: {
    ...
    axios
      .get("https://api-prestamos.onrender.com/materials",{
        headers: {
            Authorization: `Bearer ${token}`, 
          },
      })
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://api-prestamos.onrender.com/prestamosCreate", prestamo, {
        headers: {
